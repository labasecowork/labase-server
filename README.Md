...
DIRECT_URL=postgresql://root:root@localhost:5432/labase-service
...
AWS_KEY_ACCESS=your_access_key
AWS_KEY_ACCESS_SECRET=your_secret_key
...
QR_CODE_ALPHABET=1234567890abcdef
QR_CODE_LENGTH=10

# RENIEC/Decolecta (document validation)
