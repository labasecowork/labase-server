...
- **helmet** - middleware de seguridad para Express, aplica headers (CSP, HSTS, etc.).
- **express-basic-auth** - agrega autenticación básica (usuario/contraseña) para rutas como /docs.
